...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleWebClientResponseException(WebClientResponseException ex) {
        log.error("Handled WebClientResponseException: status={}, body={}",
    ...
    public ResponseEntity<Map<String, Object>> handleGenericException(Exception ex) {
        ...
        //Walk the exception cause chain to preserve the original HTTP status when exceptions are wrapped (retry/app/clients).
